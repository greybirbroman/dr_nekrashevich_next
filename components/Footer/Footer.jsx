...
function Footer() {
    ...
    const { image, owner, author, other } = footerData.footer;

    return (
        <footer className="flex flex-col bg-cyan-700 text-white pb-sm md:pb-md lg:pb-lg lg:pb-0 overflow-hidden w-full relative">
