...
function Footer() {
  ...
  return (
    <footer className='flex flex-col items-center z-10 bg-cyan-700 text-white relative overflow-hidden'>
       <Image src={Toothbrush} alt='Зубная щетка, изображение' width={500} height={500} quality={100} className='absolute right-0 w-auto h-auto xs:w-[150px] xs:bottom-0 sm:w-[150px] sm:bottom-0 md:w-[200px] md:bottom-0'/>
      <Work />
      <a
        target='_blank'
